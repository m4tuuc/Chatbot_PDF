...
def main():
    ...
    chain = prompt | RunnableLambda(prompt_value_to_str) | qa_chain | StrOutputParser()
    ...
    with col_derecha:
        ...
        if 'qa_chain' in st.session_state:
            ...
            response_placeholder.info("La respuesta aparecera aquí.")
                ...
                if query_text:
                    with st.spinner("Pensando..."):
                        try:
                            ...
                            # Truncar la respuesta a un máximo de 200 caracteres
                            if len(answer_full) > 200:
                                st.session_state.answer = answer_full[:200] + "..."
                            else:
